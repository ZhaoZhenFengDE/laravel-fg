...
@section('content')
	...
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				...
				<li><a href="{{url('admin/psw')}}" target="main">修改密码</a></li>
		...
		<ul>
			<li>
				...
				<ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/products/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加商品</a></li>
                    <li><a href="{{url('admin/products')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>全部商品</a></li>
				</ul>
			</li>
			<li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.lthuali.com">http://www.lthuali.com</a>.
	</div>
	<!--底部 结束-->
	@endsection