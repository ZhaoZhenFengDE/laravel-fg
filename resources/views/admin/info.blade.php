...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方网站：</label><span><a href="#">http://www.lthuali.com</a></span>
                </li>
                <li>
                    <label>官方交流QQ：</label><span><a href="#"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png"></a></span>
                </li>
            </ul>
        </div>
    </div>
